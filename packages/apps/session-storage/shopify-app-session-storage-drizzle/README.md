...
There are 2 adapters for Drizzle: `DrizzleSessionStoragePostgres` and `DrizzleSessionStorageMySQL`.
...
Follow the Drizzle documentation for [PostgreSQL setup](https://orm.drizzle.team/docs/get-started-postgresql) and [MySQL setup](https://orm.drizzle.team/docs/get-started-mysql).
